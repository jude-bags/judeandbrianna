...
import { 
  ...
  Check, User, UserPlus, Filter, User2, UsersRound, ClipboardCheck, Search, Tags
} from 'lucide-react';
...
export default function RSVPDashboard() {
  ...
  const columns = useMemo<ColumnDef<RSVP, any>[]>(() => [
    ...
    // ... keep existing code (name column)
    ...
    // ... keep existing code (email column)
    ...
    // ... keep existing code (attending column)
    ...
    // ... keep existing code (bringingGuest column)
    ...
    // ... keep existing code (guestName column)
    ...
    // ... keep existing code (group column)
    ...
    // ... keep existing code (foodRestrictions column)
    ...
    // ... keep existing code (adminNote column)
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {customGroups.map(group => (
                      <Badge 
                        key={group}
                        className="cursor-pointer bg-purple-800/40 hover:bg-purple-700/60 text-white border-purple-700/30"
